  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (value !== '') {
        ...
        if (pattern && !new RegExp('^(?:' + pattern + ')$').test(value)) {
          showError(field, field.title || label + ' format is invalid.');
          return false;
        }
      }
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      fetch(action, {
        ...
        .catch(function () {
          const errorContainer = contactForm.querySelector('.form-submit-error');
          if (errorContainer) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "שנה קפה לידן משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'e69be9af-2375-4888-ae59-c802af20a524',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'e69be9af-2375-4888-ae59-c802af20a524';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'e69be9af-2375-4888-ae59-c802af20a524';
